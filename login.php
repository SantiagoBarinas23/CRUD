...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($username) || empty($password)) {
        $error = '⚠️ Usuario y contraseña son requeridos';
    } else {
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <?php if($error): ?>
                <div class="alert alert-danger" role="alert" style="margin: 20px 0; padding: 15px; background: rgba(220, 53, 69, 0.1); border: 1px solid rgba(220, 53, 69, 0.3); border-radius: 12px; color: #dc3545;">
            ...
            <?php if(isset($_SESSION['logout_message'])): ?>
                <div class="alert alert-info" role="alert" style="margin: 20px 0; padding: 15px; background: rgba(13, 202, 240, 0.1); border: 1px solid rgba(13, 202, 240, 0.3); border-radius: 12px; color: #0dcaf0;">
